      ...
      <footer class="text-center bg-nero" aria-label="Footer principale">
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            ...
            <div class="p-1 border-bottom d-block d-md-none mb-3" id="separatoreFooter01" style="border-color: #009fb7"></div>
          ...
          <div class="row bg-giallo align-middle">
            <div class="col d-flex flex-column align-items-center justify-content-center mt-2">
              <p class="align-middle fontFirma02">Sito realizzato da _ <span class="fontFirma"> Andrea Bianchi</span></p>
            </div>
          </div>
        </div>
