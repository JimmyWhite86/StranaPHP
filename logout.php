...
<body>
  ...
  <div class="container-fluid d-flex justify-content-center bg-azzurro py-4 my-4 myShadowNera">
    <div class="row bg-bianco justify-content-center col-10 col-sm-6 text-center rounded-3 myShadowNera my-3">
        <h1 class="fontTitoloSezione my-4 fontVerde">Logout effettuato correttamente</h1>
